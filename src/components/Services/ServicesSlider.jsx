...
export default function ImageCycle({ items }) {
  ...
  return (
    <div
      className="grid items-center gap-6 w-full h-100">
      ...
      <div className="image-cycle-collection">
        <div className="image-cycle-collection__before" />
        <div
          className="image-cycle-collection__list w-full h-auto relative overflow-hidden"
          ref={containerRef}
          data-image-cycle
        >
          {items.map((item, i) => (
